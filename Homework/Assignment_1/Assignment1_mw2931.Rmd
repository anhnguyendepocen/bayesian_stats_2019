...
1. If the first roll is a strike, then you get two more rolls. For the first extra roll, there are 10 pins upright and if you knock them all down then they put 10 pins back up for the second extra roll. Otherwise, the second extra roll just has however many pins are left.
So `probability of a strike * 10 pins + probability of no bonus strike * sum(joint_P`

2. If the first roll is not a strike, but the second roll gets a spare, then you get one extra roll with 10 pins upright.
If you do not get a spare, then there are no extra rolls.
